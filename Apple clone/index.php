...
<body>
    ...
    <section class="form-section">
        <form action="autenticazione.php" method="POST">
            <?php
                if (isset($_GET['error'])) {
                    $errors = array("ID Apple o password vuoti", "ID Apple inesistente", "Password errata", "Devi effettuare l'accesso");
            ...
            <input id="btn" type="submit" name="accedi" value="Accedi">
            <input id="btn" type="submit" name="portale-registrati" value="Registrati">
        </form>
    </section>
</body>
</html>